...
Cragmor would, over the first half of the twentieth century, become a relatively prominent tuberculosis sanitarium. Solly passed away in 1906, and the institution was run by a number of directors in the following years, including Alexius M. Forster and Gerald Webb.[^fn5] It was one of many institutions in the city which had advertised its sunshine and dry air to attract tuberculous patients to stay (fig 2.). Over the first decades of the century the Cragmor Sanatorium continued to grow, before beginning to decline during the depression. It would be eventually be subsumed into the University of Colorado system.[^fn6]



<img id="TheJournaloftheOutdoorlif12_1915_97" src="{{ site.baseurl }}/assets/items/TheJournaloftheOutdoorlif12_1915_97.jpg">
...
Solly’s idealistic, glamorous vision for a sanatorium matched an aesthetic that catered to a well to do clientele. It was meant to be a healing resort, and its target tuberculous audience corresponded with the images of healing seen in Davos ([1.2.2](https://tuberculosisspecimen.github.io/diss/dissertation/1_2_2.html)). The architectural fervor which guided the extravagant initial plans echo the space-as-remedy approach many doctors and institutions took to address the disease ([1.2.2](https://tuberculosisspecimen.github.io/diss/dissertation/1_2_2.html); [1.2.3](https://tuberculosisspecimen.github.io/diss/dissertation/1_2_3.html)). More importantly, the sanatorium was something that could, and should, be built with specific structural considerations in mind, and its construction served as an anchor for both the medical profession, as well as a feather in the cap of a growing city, aspiring to be a hub of culture and industry. 

Roughly sixty miles north of Cragmor and opening six years prior to Solly’s sanatarium the NJHC opened its doors to care for the nation’s consumptive poor. It and its sister institution, the National Jewish Consumptive Relief Society (NJCRS), operated entirely on donations provided by Jewish communities and individuals across the nation. Where the NJHC required admission, with patients selected at the digression of the hospital’s staff, the NJCRS accepted any and all patients, some of whom were so sickly that they died within twenty-four hours of their admission. 
...
<img id="TheSanatorium6-10_1916_137" src="{{ site.baseurl }}/assets/items/TheSanatorium6-10_1916_137.jpg">
...
<img id="TheSanatorium6-10_1916_157" src="{{ site.baseurl }}/assets/items/TheSanatorium6-10_1916_157.jpg">
...
<img id="TheSanatorium6-10_1916_151" src="{{ site.baseurl }}/assets/items/TheSanatorium6-10_1916_151.jpg">
...
<img id="TheSanatorium6-10_1916_670" src="{{ site.baseurl }}/assets/items/TheSanatorium6-10_1916_670.jpg">
...
<img id="ModHospital_NJHC_1" src="{{ site.baseurl }}/assets/items/ModHospital_NJHC_1.jpg">
...
<img id="ModHospital_NJHC_2" src="{{ site.baseurl }}/assets/items/ModHospital_NJHC_2.jpg">
...
<img id="ModHospital_NJHC_3" src="{{ site.baseurl }}/assets/items/ModHospital_NJHC_3.jpg">
...
<img id="TheBritishJournalofTuberc1_1907_74" src="{{ site.baseurl }}/assets/items/TheBritishJournalofTuberc1_1907_74.jpg">
...
[^fn6]: McKay, Douglas R. *The Asylum of the Gilded Pill: The Story of Cragmor Sanatorium*. State Historical Society of Colorado, 1983. 20.
